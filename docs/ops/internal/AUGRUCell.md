...
**Detailed description**: The main difference between *AUGRUCell* and [GRUCell](../../ops/sequence/GRUCell_3.md) is the additional attention score input `A`, which is a multiplier for the update gate.
